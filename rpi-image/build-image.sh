...
for f in start-kiosk-x11.sh start-kiosk-now.sh xinitrc-kiosk wifi-setup-server.mjs wifi-hotspot.sh wifi-apply-bootconf.sh masjidconnect-wifi-bootconf.service wifi-watchdog.sh masjidconnect-wifi-watchdog.service masjidconnect-rtc-sync.service update-from-github.sh install-release.sh; do
