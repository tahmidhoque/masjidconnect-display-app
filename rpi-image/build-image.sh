...
for f in start-kiosk-x11.sh start-kiosk-now.sh xinitrc-kiosk server.mjs masjidconnect-display.service wifi-setup-server.mjs wifi-hotspot.sh wifi-apply-bootconf.sh masjidconnect-wifi-bootconf.service wifi-watchdog.sh masjidconnect-wifi-watchdog.service masjidconnect-rtc-sync.service rtc-sync.sh http-time-sync.sh masjidconnect-http-time.service masjidconnect-http-time.timer update-from-github.sh install-release.sh; do
