...
export class DebugEventSource {
  ...
  constructor(url: string, options?: EventSourceInit) {
    ...
    console.log(
      "🔍 DebugEventSource: Creating new connection to",
      url,
      "with options:",
      options,
    );
  ...
  addEventListener(
    ...
    console.log(
      "🔍 DebugEventSource: Adding event listener for event type:",
      type,
    );
    ...
    const wrappedListener = (event: Event) => {
      if (event instanceof MessageEvent) {
        ...
        console.log(
          `🔍 DebugEventSource: Non-message event '${type}' received`,
          {
            event,
            timestamp: new Date().toISOString(),
          },
  ...
  removeEventListener(
    ...
    console.log(
      "🔍 DebugEventSource: Removing event listener for event type:",
      type,
    );
  ...
  public logState(): void {
    ...
    console.log("🔍 DebugEventSource: Current state", {
      ...
      readyState: this.readyState,
      readyStateText:
        readyStateMap[this.readyState as keyof typeof readyStateMap],
