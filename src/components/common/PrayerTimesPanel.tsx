...
const PrayerTimesPanel: React.FC<PrayerTimesPanelProps> = ({
  ...
  const { todaysPrayerTimes, nextPrayer, isJumuahToday, jumuahDisplayTime } =
    usePrayerTimes();

  const { fontSizes, layout, screenSize, getSizeRem, getSizePx } =
      ...
      >
        ...
        <Box
          sx={{
            ...
            boxSizing: "border-box",
            backgroundImage:
              "linear-gradient(rgba(246, 248, 250, 0.5) 50%, transparent 50%)",
            ...
            todaysPrayerTimes.map((prayer, index) => (
              <Box
                ...
                sx={{
                  ...
                  position: "relative",
                  borderRadius:
                    prayer.isNext || prayer.isCurrent ? "8px" : "0px",
                  borderBottom:
                    index < todaysPrayerTimes.length - 1
