 ...
 */
const GlassmorphicPrayerTimesPanel: React.FC<GlassmorphicPrayerTimesPanelProps> = ({
  ...
  return (
    ...
    >
      <Box sx={{ p: getSizeRem(1.2) }}>
        ...
        <Divider sx={{ backgroundColor: alpha(theme.palette.warning.main, 0.3), mb: getSizeRem(0.8) }} />
            ...
            >
              ...
              >
                ...
                {prayer.name === 'Zuhr' && isJumuahToday && (
                  <Box component="span" sx={{ 
                    ml: 1,
                    fontSize: isPortrait ? fontSizes.caption : fontSizes.body2,
              ...
              <Typography 
                sx={{ 
                  ...
                  textAlign: 'end',
                  fontWeight: prayer.isNext ? 600 : 500,
                  color: prayer.isNext && prayer.displayJamaat
                    ? alpha(theme.palette.warning.light, 0.9)
                    : prayer.displayJamaat ? '#ffffff' : alpha('#ffffff', 0.5),
                  fontFamily: "'Poppins', sans-serif",
                }}
              >
