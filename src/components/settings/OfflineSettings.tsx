...
const OfflineSettings: React.FC = () => {
  ...
  const handleClearCache = async (type?: 'content' | 'prayer-times' | 'events' | 'announcements' | 'images') => {
    setLoading(true);
    setMessage(null);
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} sm={6}>
          <TextField
            ...
            onChange={(e) => handleSettingChange('maxCacheSize', parseInt(e.target.value) || 500)}
            fullWidth
        ...
        <Grid item xs={12} sm={6}>
          <TextField
            ...
            onChange={(e) => handleSettingChange('syncFrequency', parseInt(e.target.value) || 5)}
            fullWidth
        ...
        <Grid item xs={12} sm={4}>
          <TextField
            ...
            onChange={(e) => handleSettingChange('contentTTL', parseInt(e.target.value) || 24)}
            fullWidth
        ...
        <Grid item xs={12} sm={4}>
          <TextField
            ...
            onChange={(e) => handleSettingChange('prayerTimesTTL', parseInt(e.target.value) || 7)}
            fullWidth
        ...
        <Grid item xs={12} sm={4}>
          <TextField
            ...
            onChange={(e) => handleSettingChange('eventsTTL', parseInt(e.target.value) || 24)}
            fullWidth
            inputProps={{ min: 1, max: 168 }}
          />
        </Grid>
        ...
        <Grid item xs={12}>
          ...
          <Box sx={{ display: 'flex', gap: 1, flexWrap: 'wrap', mt: 1 }}>
            {(['content', 'prayer-times', 'events', 'announcements', 'images'] as const).map((type) => (
              <Button
                key={type}
                size="small"
                variant="outlined"
