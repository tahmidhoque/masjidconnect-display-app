...
export const selectOfflineStartTime = (state: { ui: UIState }) => state.ui.offlineStartTime;
export const selectIsInitializing = (state: { ui: UIState }) => state.ui.isInitializing;
export const selectInitializationStage = (state: { ui: UIState }) => state.ui.initializationStage;
...
export const selectUpdateDownloaded = (state: { ui: UIState }) => state.ui.updateDownloaded;
export const selectUpdateError = (state: { ui: UIState }) => state.ui.updateError;
export const selectShowLoadingScreen = (state: { ui: UIState }) => state.ui.showLoadingScreen;
export const selectShowContent = (state: { ui: UIState }) => state.ui.showContent;
...
export const selectRenderCount = (state: { ui: UIState }) => state.ui.renderCount;
export const selectLastRenderTime = (state: { ui: UIState }) => state.ui.lastRenderTime;
export const selectIsKioskMode = (state: { ui: UIState }) => state.ui.isKioskMode;
export const selectPreventContextMenu = (state: { ui: UIState }) => state.ui.preventContextMenu;
export const selectPreventKeyboardShortcuts = (state: { ui: UIState }) => state.ui.preventKeyboardShortcuts;
