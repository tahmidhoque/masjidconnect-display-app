...
/* Soft cream light theme — validates panel/surface contrast on light backgrounds. */
...
/** Portrait brochure poster — a literal ANNOUNCEMENT slide (not verse, not Janazah). */
const jumuahAnnouncement = () => ({
  ...announcement(),
  id: 'sc-ann-jumuah',
  title: 'Jumu’ah this Friday',
  content: {
    body: 'Join us this Friday for two congregations. First khutbah at 1:15pm, second at 2:15pm. Families welcome — please arrive a few minutes early so we can start on time.',
    textAlign: 'center',
  },
});
...
export const SCENARIOS: Record<string, Scenario> = {
  ...
  /** Same portrait stack as pt-full, with an announcement poster in the content zone. */
  'pt-announcement': {
    id: 'pt-announcement',
    orientation: 'PORTRAIT',
    layout: config('portrait', PT_FULL),
    scheduleItems: [jumuahAnnouncement()],
  },
  'pt-prayer-focus': {
    id: 'pt-prayer-focus',
    orientation: 'PORTRAIT',
  ...
  /** Light cream theme — validates surface contrast on light backgrounds. */
